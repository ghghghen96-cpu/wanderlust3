...
const Itinerary = () => {
    ...
    const parsedLocal = (() => { try { return JSON.parse(localStorage.getItem('last_search_data') || '{}'); } catch { return {}; } })();
    const data = location.state || (parsedLocal && parsedLocal.destination ? parsedLocal : {});
    ...
    }, [effectiveData.destination, effectiveData.destinationId, i18n.language, sessionData]);
    ...
    const handleShare = useCallback(async () => {
        if (sessionId) {
            ...
            try {
                const newId = await createSharedSession(effectiveData, itinerary, flights, hotels);
    ...
    }, [sessionId, t, effectiveData, itinerary, flights, hotels, navigate, location.pathname]);
