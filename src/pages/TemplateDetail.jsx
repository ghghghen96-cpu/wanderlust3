                                            ...
                                            {dayPlan.items && dayPlan.items.length > 0 ? (
                                                dayPlan.items.map((item, idx) => (
                                                    <div key={item.id || idx} className="relative pl-6 pb-2">
                                                        ...
                                                        <div className="bg-[#f5f5f5] rounded-2xl p-5 border border-[#e7e5e4] hover:shadow-md transition-shadow">
                                                            <div className="flex flex-col md:flex-row gap-6">
                                                                <div className="flex-1">
                                                                    <div className="flex items-start justify-between gap-4 mb-2">
                                                                        <h4 className="font-bold text-lg text-[#1c1917]">{item.name}</h4>
                                                                        <span className="text-sm font-bold text-[#000] bg-[#FBBF24] px-2.5 py-1 rounded-lg shrink-0">
                                                                            {item.time || "--:--"}
                                                                        </span>
                                                                    </div>
                                                                    <p className="text-sm text-[#78716c] mb-3 leading-relaxed">{item.desc}</p>
                                                                ...
                                                                <div className="w-full md:w-64 shrink-0">
                                                                    <ExternalPlaceImage 
                                                                        name={item.name} 
                                                                        initialUrl={item.img || item.image} 
